...
Sluice.prototype.addToSimulation = function(simulation) {
  ...
  var sluiceLevelAt = function(levelOriginX, levelOriginY, bodyDef, fixtureDef) {
    ...
    sluiceVerts.push(new Box2D.Common.Math.b2Vec2(levelOriginX - 0.50, levelOriginY));
    sluiceVerts.push(new Box2D.Common.Math.b2Vec2(levelOriginX - 0.50, levelOriginY - 0.03));
    sluiceVerts.push(new Box2D.Common.Math.b2Vec2(levelOriginX - 0.32, levelOriginY - 0.045));
    sluiceVerts.push(new Box2D.Common.Math.b2Vec2(levelOriginX - 0.32, levelOriginY - 0.015));
    fixtureDef.shape.SetAsArray(sluiceVerts);
    sluiceLevel.CreateFixture(fixtureDef);
    sluiceVerts = new Array();
    sluiceVerts.push(new Box2D.Common.Math.b2Vec2(levelOriginX - 0.32, levelOriginY - 0.015));
    sluiceVerts.push(new Box2D.Common.Math.b2Vec2(levelOriginX - 0.32, levelOriginY - 0.045));
    sluiceVerts.push(new Box2D.Common.Math.b2Vec2(levelOriginX - 0.26, levelOriginY - 0.045));
    sluiceVerts.push(new Box2D.Common.Math.b2Vec2(levelOriginX - 0.26, levelOriginY - 0.015));
    fixtureDef.shape.SetAsArray(sluiceVerts);
    sluiceLevel.CreateFixture(fixtureDef);
    sluiceVerts = new Array();
    sluiceVerts.push(new Box2D.Common.Math.b2Vec2(levelOriginX - 0.26, levelOriginY - 0.015));
    sluiceVerts.push(new Box2D.Common.Math.b2Vec2(levelOriginX - 0.26, levelOriginY - 0.045));
    sluiceVerts.push(new Box2D.Common.Math.b2Vec2(levelOriginX - 0.09, levelOriginY - 0.03));
